...
# Smart Grid Energy Distribution Simulation ⚡

A Python-based simulation of a **smart electrical grid** featuring generators, substations, and consumers. The system demonstrates intelligent energy distribution using priority-based allocation and maximum flow optimization, along with dynamic fault injection.

## ✨ Features

- **Multi-layer Grid Architecture**: Generators → Substations → Consumers
- **Priority-based Energy Distribution**: Higher priority consumers get preference during power shortages
- **Dynamic Fault Injection**: Random edge failures to simulate real-world grid faults
- **Maximum Flow Optimization**: Uses NetworkX for optimal power flow routing
- **Real-time Animation**: Live visualization of energy flow and system status
- **Telemetry Dashboard**: Shows supply, demand, satisfaction rate, and fault status

## 🛠 Technologies Used

- **NetworkX** – Graph modeling and maximum flow algorithm
- **Matplotlib** – Animation and network visualization
- **Python** – Core logic
